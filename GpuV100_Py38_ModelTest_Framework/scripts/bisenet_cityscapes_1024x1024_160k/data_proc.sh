...
if [ -d "$cur_path/../../seg_repo/data/VOCdevkit" ]; then
rm -rf $cur_path/../../seg_repo/data/VOCdevkit
fi
ln -s /workspace/task/dataset/pascalvoc/VOCdevkit /workspace/task/seg_repo/data/VOCdevkit
